...
glb_all_analysis_list <- c(
  ...
  "motiftwo_entro3"
  # TAKE A LOT OF TIME: "compengine", "sampenc", "sampen_first",
  #     "fluctanal_prop_r1"
  # DON'T WORK: "binarize_mean", "embed2_incircle" (require param),
  #     "hw_parameters"
)
glb_root_folder <- "G:/Mi unidad/WHY/Datasets/" 
  #"D:/Quesada/Documents/__TRABAJO/Deusto/WHY/Datasets/"
glb_subfolders <- list(
  lcl = "lcl/"
)
