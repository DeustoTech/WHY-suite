...
4. **Goiener & Megara (all)**: The same as dataset #1 but including all time series regardless their CNAE codes. Contains 11,840 time series.
...
In this report, at the beginning of each dataset subsection, the density of features for that dataset (i.e. the distribution of values for that feature and dataset) is shown.
