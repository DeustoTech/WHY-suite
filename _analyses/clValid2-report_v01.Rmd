...
# Introduction
This report contains the results of applying three clustering methods to four datasets of energy consumption at household level. For each dataset, clustering method and resulting cluster, a set of graphs is displayed, the meaning of which is explained in the following sections.

## Datasets
The datasets consist of time series of at least two years' duration representing energy consumption in kWh at the residential level.
