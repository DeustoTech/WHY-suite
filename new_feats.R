...
#   
#   # Base
#   o <- list(abs=NULL, rel=NULL)
#   for (ii in 1:2) {
#     # Main branches
#     o[[ii]] <- list(mean=NULL, sd=NULL, sum=NULL, max=NULL, min=NULL)
#     # Block names
#     for (jj in 1:5) {
#       o[[ii]][[jj]] <- list(
#         block_1=NULL,
...
#             )
#           }
#           names(name_list) <- names(p7_str[1:6])
#           o[[ii]][[jj]][[kk]] <- name_list
#         }
#         ### 2.0TD 7 periods
#         if (kk == 10) {
#           name_list <- list()
...
#             )
#           }
#           names(name_list) <- names(p7_str[1:7])
#           o[[ii]][[jj]][[kk]] <- name_list
#         }
#         ### 2.0TD 6 periods + season
#         if (kk == 11) {
#           name_list <- list()
#           for (mm in 1:7) {
#             name_list[[mm]] <- paste(
