...
clValid2_heatmaps <- function() {
  ...
  if (.Platform$OS.type == "windows") {
    feats_path  <- "C:/Users/carlos.quesada/Documents/WHY/2022.01.21 - Errores en ClValid2 PST/feats_go4_pst.csv"
    clValid_dir <- "C:/Users/carlos.quesada/Documents/WHY/2022.01.21 - Errores en ClValid2 PST/"
    dataset_dir <- c(goi="C:/Users/carlos.quesada/Documents/WHY/2022.01.21 - Errores en ClValid2 PST/pst/")
    hmm_dir     <- "C:/Users/carlos.quesada/Documents/WHY/2022.01.21 - Errores en ClValid2 PST/hmm/"
    hmp_dir     <- "C:/Users/carlos.quesada/Documents/WHY/2022.01.21 - Errores en ClValid2 PST/hmp/"
  }
  if (.Platform$OS.type == "unix") {
    feats_path  <- "/home/ubuntu/carlos.quesada/disk/features/feats_go4_pre.csv"
    clValid_dir <- "/home/ubuntu/carlos.quesada/analyses/clValid2/2022.01.17_go4-pre-unscaled/data/"
    # As named vector for each dataset
    dataset_dir <- c(goi="/home/ubuntu/carlos.quesada/disk/go4_pre/imp/")
    hmm_dir     <- "/home/ubuntu/carlos.quesada/analyses/clValid2/2022.01.17_go4-pre-unscaled/hmm/"
    hmp_dir     <- "/home/ubuntu/carlos.quesada/analyses/clValid2/2022.01.17_go4-pre-unscaled/hmp/"
  }
  ...
  #   for(cc in 2:number_of_clusters) {
      ...
      # DELETE THIS #------------------------------------------------------------------------
      # paths_vector <- list.files(path = dataset_dir, pattern = "*.RData", full.names = TRUE)
