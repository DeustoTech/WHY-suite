  ...
  for (dd in dd_loop) {
    ...
    for (mm in mm_loop) {
      ...
      for (cc in cc_loop) {
        ...
        if (dd == 2) {
          # GOI filename formation
          lcl_fname <- paste0("lcl_", ff, dd, mm, "_", cc, "-", nc, ".png")
        ...
        if (dd == 3) {
          ...
          iss1_fname <- paste0("iss_", ff, dd, mm, "_", cc, "-", nc, "_1.png")
          iss2_fname <- paste0("iss_", ff, dd, mm, "_", cc, "-", nc, "_2.png")
          iss3_fname <- paste0("iss_", ff, dd, mm, "_", cc, "-", nc, "_3.png")
