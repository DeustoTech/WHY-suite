...
clValid2_heatmaps <- function() {
  ...
  if (.Platform$OS.type == "unix") {
    ...
    hmm_dir     <- "/home/ubuntu/carlos.quesada/analyses/clValid2/2021.05.05_3-cl-methods/hmm/"
    hmp_dir     <- "/home/ubuntu/carlos.quesada/analyses/clValid2/2021.05.05_3-cl-methods/hmp/"
